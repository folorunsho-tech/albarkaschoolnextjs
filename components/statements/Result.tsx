...
const Result = ({
	...
	return (
		<div className='relative flex flex-col gap-3'>
			...
			<ScrollAreaAutosize>
				<section className='px-4  h-screen space-y-8' ref={contentRef}>
					<header className='space-y-2 mb-2 w-full'>
						...
						<div className='flex gap-4 justify-between text-sm w-4/5'>
							...
							<p>
								Term:{" "}
								<span className='font-semibold italic'>{statement?.term}</span>
							</p>
							<p>
								Class:{" "}
								<span className='font-semibold italic'>
							...
							{!statement?.school_section?.includes("SS") && (
								<p>
									No in class:{" "}
						...
						<div className='flex flex-wrap justify-between text-sm w-4/5'>
							<p className=''>
								Admission No:{" "}
								<span className='font-semibold italic'>
					...
					<footer className='flex flex-col gap-6 text-sm '>
						<div className='space-y-8'>
							...
							{statement?.className?.includes("SS") ? (
								<div className='flex justify-between w-full'>
									<p>
										Principal's remark
